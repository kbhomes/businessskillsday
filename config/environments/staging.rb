BusinessSkillsDay::Application.configure do
  ...
  config.action_mailer.smtp_settings = {
      ...
      :user_name =>       ENV['STAGING_SMTP_USERNAME'],
      :password =>        ENV['STAGING_SMTP_PASSWORD'],
      :authentication =>  ENV['STAGING_SMTP_AUTHENTICATION'],
  }
  config.action_mailer.default_url_options = { :host => ENV['STAGING_MAIL_DEFAULT_URL'] }
  ActionMailer::Base.default(:from => ENV['STAGING_MAIL_FROM'])
